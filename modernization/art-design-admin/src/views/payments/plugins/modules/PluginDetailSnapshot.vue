...
<style scoped lang="scss">
  .drawer-section {
    ...
    --plugin-surface-bg: linear-gradient(180deg, rgb(255 255 255 / 1), rgb(255 247 237 / 0.86));
    ...
    --plugin-text-color: #6b7280;
    --plugin-muted-color: #9ca3af;
  }
  ...
  :global(html.dark .drawer-section ){
    ...
    --plugin-surface-bg-soft:
      radial-gradient(circle at top right, rgb(251 191 36 / 0.1), transparent 32%),
