...
<style scoped lang="scss">
  .media-library-page {
    ...
    gap: 16px;
    --media-preview-bg: rgb(241 245 249 / 0.92);
    --media-empty-color: #94a3b8;
    --media-hero-border: rgb(14 165 233 / 0.18);
    --media-hero-bg:
    ...
    --media-metric-border: #e4ecfc;
    --media-metric-bg: linear-gradient(180deg, rgb(248 250 252 / 0.96), rgb(241 245 249 / 0.9));
  }

  :global(html.dark .media-library-page ){
    --media-preview-bg: rgb(15 23 42 / 0.82);
    --media-empty-color: #94a3b8;
    --media-hero-border: rgb(56 189 248 / 0.28);
    --media-hero-bg:
      linear-gradient(135deg, rgb(15 23 42 / 0.96), rgb(30 41 59 / 0.92)),
      radial-gradient(circle at top right, rgb(14 165 233 / 0.2), transparent 54%);
    --media-metric-border: rgb(51 65 85 / 0.72);
    --media-metric-bg: linear-gradient(180deg, rgb(15 23 42 / 0.84), rgb(30 41 59 / 0.76));
  }
  ...
  .detail-hero {
    ...
    margin-bottom: 24px;
    padding: 20px;
    border: 1px solid var(--media-hero-border);
    border-radius: 18px;
    background: var(--media-hero-bg);
  }
  ...
  .metric-card {
    ...
    gap: 6px;
    padding: 14px 16px;
    border: 1px solid var(--media-metric-border);
    border-radius: 16px;
    background: var(--media-metric-bg);
  }
