...
<style scoped lang="scss">
  .drawer-section {
    ...
    --plugin-surface-bg: linear-gradient(180deg, rgb(255 255 255 / 1), rgb(249 250 251 / 0.92));
    ...
    --plugin-surface-bg-section: linear-gradient(180deg, rgb(255 255 255 / 1), rgb(248 250 252 / 0.94));
  ...
  :global(html.dark .drawer-section ){
    ...
    --plugin-surface-bg-soft:
      ...
      linear-gradient(180deg, rgb(30 41 59 / 0.94), rgb(15 23 42 / 0.94));
    --plugin-surface-bg-danger:
      radial-gradient(circle at top right, rgb(248 113 113 / 0.1), transparent 34%),
      linear-gradient(180deg, rgb(30 41 59 / 0.96), rgb(15 23 42 / 0.94));
    --plugin-surface-bg-section: linear-gradient(180deg, rgb(15 23 42 / 0.96), rgb(2 6 23 / 0.94));
  ...
  .plugin-config-section {
    ...
    border: 1px solid var(--plugin-card-border);
    border-radius: 16px;
    background: var(--plugin-surface-bg-section);
  }
