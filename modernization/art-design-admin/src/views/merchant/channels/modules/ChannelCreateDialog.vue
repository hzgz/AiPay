      ...
      <div v-if="isCreateFormReady" class="merchant-channel-create-form">
        <section class="channel-form-section">
          ...
          <template v-else>
            ...
            <ElFormItem
              v-if="showCreateIdentifierField"
              :label="displayAccountFieldLabel(activeCreateMeta.identifierLabel)"
            >
              <ElInput
            ...
            <template v-if="activeCreateMeta.qrTypeOptions.length > 0">
              <ElFormItem :label="routeModeLabel">
                ...
                <ElSelect v-else v-model="selectedCreateQrType" :placeholder="qrTypePlaceholder">
                  <ElOption
                    v-for="option in activeCreateMeta.qrTypeOptions"
                    :key="option.value"
                    :label="option.label"
            ...
            <div class="credential-field-shell">
              ...
              <template v-else-if="createQrUrlEditor === 'qr-decode'">
                ...
                <div class="credential-field-actions">
                  ...
                  >
                    <ElButton :loading="isCreateQrUrlUploading" plain> 上传二维码并解析 </ElButton>
                  </ElUpload>
                  <ElButton v-if="createForm.qr_url" link type="danger" @click="clearCreateQrUrl">
                    清空
                  </ElButton>
...
<script setup lang="ts">
  ...
  interface Props {
    ...
    isAssetUploading: (scope: 'create', field: PaymentAccountCredentialField) => boolean
    ...
    clearScopedCredentialField: (scope: 'create', field: PaymentAccountCredentialField) => void
  }
  ...
  const showCreateIdentifierField = computed(() =>
    shouldShowAccountIdentifierField(props.createForm.code, props.createForm.qr_type)
  )
  const qrTypePlaceholder = computed(() => resolveQrTypeFieldPlaceholder(props.createForm.code))
