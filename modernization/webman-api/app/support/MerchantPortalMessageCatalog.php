...
final class MerchantPortalMessageCatalog
{
    ...
    private const MESSAGE_MAP = [
        ...
        'merchant affiliate page is read-only in the Webman merchant center' => '当前推广返佣页面仅提供统计查看与邀请链接复制，不提供重置邀请链接或返佣提现。',
        ...
        'merchant order callback replay and status reset flows are not migrated for Webman merchant center yet' => '当前订单页已支持回调重放，状态重置入口已关闭。',
