...
<style scoped lang="scss">
  .PluginScaffoldDialog :deep(.el-dialog__body) {
    display: flex;
  ...
  .PluginScaffoldDialog {
    --plugin-card-border: rgb(148 163 184 / 0.16);
    --plugin-surface-bg: linear-gradient(180deg, rgb(255 255 255 / 1), rgb(248 250 252 / 0.96));
  ...
  :global(html.dark .PluginScaffoldDialog ){
