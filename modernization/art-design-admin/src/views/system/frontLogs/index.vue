...
<style scoped lang="scss">
  .front-logs-page {
    ...
    gap: 16px;
    --front-hero-border: rgb(251 191 36 / 0.24);
    --front-hero-bg:
    ...
    --front-hero-title: #0f172a;
    --front-hero-text: #6b7280;
  }

  :global(html.dark .front-logs-page ){
    --front-hero-border: rgb(245 158 11 / 0.32);
    --front-hero-bg:
      linear-gradient(135deg, rgb(17 24 39 / 0.96), rgb(15 23 42 / 0.92)),
      radial-gradient(circle at top right, rgb(245 158 11 / 0.18), transparent 52%);
    --front-hero-title: #f8fafc;
    --front-hero-text: #cbd5e1;
  }
