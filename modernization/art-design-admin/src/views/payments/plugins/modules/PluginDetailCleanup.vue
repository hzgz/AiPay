...
<style scoped lang="scss">
  .drawer-section {
    ...
    gap: 12px;
    margin-bottom: 20px;
    --plugin-card-border: rgb(226 232 240 / 0.92);
    --plugin-surface-bg: linear-gradient(180deg, rgb(248 250 252 / 0.96), rgb(255 255 255 / 1));
    ...
    --plugin-surface-bg-safe: linear-gradient(180deg, rgb(240 253 244 / 0.9), rgb(255 255 255 / 1));
    --plugin-surface-bg-purge: linear-gradient(180deg, rgb(255 247 237 / 0.9), rgb(255 255 255 / 1));
    ...
    --plugin-surface-panel: rgb(255 255 255 / 0.72);
    --plugin-title-color: #111827;
    --plugin-text-color: #4b5563;
    --plugin-muted-color: #6b7280;
    --plugin-soft-color: #9ca3af;
  }
  ...
  :global(html.dark .drawer-section ){
    ...
    --plugin-surface-bg-safe: linear-gradient(180deg, rgb(15 23 42 / 0.96), rgb(2 6 23 / 0.94));
    --plugin-surface-bg-purge: linear-gradient(180deg, rgb(30 41 59 / 0.96), rgb(15 23 42 / 0.94));
    --plugin-surface-bg-warning:
      radial-gradient(circle at top right, rgb(251 191 36 / 0.12), transparent 34%),
      linear-gradient(180deg, rgb(30 41 59 / 0.96), rgb(15 23 42 / 0.94));
    --plugin-surface-panel: rgb(15 23 42 / 0.84);
    --plugin-title-color: #e2e8f0;
    --plugin-text-color: #cbd5e1;
    --plugin-muted-color: #94a3b8;
    --plugin-soft-color: #64748b;
  }
  ...
  .plan-card.safe {
    background: var(--plugin-surface-bg-safe);
  }

  .plan-card.purge {
    background: var(--plugin-surface-bg-purge);
  }
  ...
  .plan-result {
    ...
    padding: 12px 14px;
    border-radius: 12px;
    background: var(--plugin-surface-panel);
    color: var(--plugin-text-color);
    font-size: 13px;
  }
