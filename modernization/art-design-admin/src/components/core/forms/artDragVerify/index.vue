...
<script setup lang="ts">
  ...
  const props = withDefaults(defineProps<PropsType>(), {
    ...
    handlerBg: 'var(--el-bg-color-overlay)',
    textSize: '13px',
    textColor: 'var(--el-text-color-secondary)'
  })
...
<style lang="scss" scoped>
  .drag_verify {
    --drag-verify-handler-icon: #999;
    --drag-verify-success-icon: #6c6;
    --drag-verify-highlight: rgb(255 255 255 / 0.94);
    position: relative;
    ...
    .dv_handler {
      ...
      i {
        padding-left: 0;
        font-size: 14px;
        color: var(--drag-verify-handler-icon);
      }

      .el-icon-circle-check {
        margin-top: 9px;
        color: var(--drag-verify-success-icon);
      }
    }
  ...
  .dark .drag_verify {
    --drag-verify-handler-icon: #cbd5e1;
    --drag-verify-success-icon: #86efac;
    --drag-verify-highlight: rgb(241 245 249 / 0.92);
  }
</style>
