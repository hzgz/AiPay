...
<style scoped lang="scss">
  ...
  .vault-card {
    --plugin-card-border: rgb(30 58 95 / 0.12);
    --plugin-surface-bg: linear-gradient(180deg, rgb(248 250 252 / 0.98), rgb(255 255 255 / 1));
    --plugin-surface-bg-soft:
    ...
    --plugin-surface-bg-info:
      ...
      linear-gradient(180deg, rgb(248 250 252 / 0.98), rgb(255 255 255 / 1));
    --plugin-title-color: #0f172a;
    --plugin-text-color: #475569;
    --plugin-muted-color: #64748b;
    --plugin-accent-color: #1d4ed8;
  }

  :global(html.dark .vault-card ){
    --plugin-card-border: rgb(71 85 105 / 0.42);
    --plugin-surface-bg: linear-gradient(180deg, rgb(15 23 42 / 0.96), rgb(2 6 23 / 0.94));
    --plugin-surface-bg-soft:
      radial-gradient(circle at top right, rgb(5 150 105 / 0.1), transparent 24%),
      radial-gradient(circle at left bottom, rgb(30 58 95 / 0.08), transparent 28%),
      linear-gradient(180deg, rgb(15 23 42 / 0.96), rgb(2 6 23 / 0.94));
    --plugin-surface-bg-danger:
      radial-gradient(circle at top right, rgb(248 113 113 / 0.1), transparent 28%),
      radial-gradient(circle at left bottom, rgb(251 191 36 / 0.08), transparent 34%),
      linear-gradient(180deg, rgb(31 41 55 / 0.96), rgb(15 23 42 / 0.94));
    --plugin-surface-bg-info:
      radial-gradient(circle at top right, rgb(59 130 246 / 0.1), transparent 28%),
      radial-gradient(circle at left bottom, rgb(15 23 42 / 0.08), transparent 34%),
      linear-gradient(180deg, rgb(15 23 42 / 0.96), rgb(2 6 23 / 0.94));
  ...
  .residue-ledger-card {
    ...
    background: var(--plugin-surface-bg-info);
  }
  ...
  .residue-card .vault-stat.warning {
    background: linear-gradient(180deg, rgb(255 237 213 / 0.96), rgb(15 23 42 / 0.94));
  }

  .residue-card .vault-stat.success {
    background: linear-gradient(180deg, rgb(254 242 242 / 0.96), rgb(15 23 42 / 0.94));
  }
  ...
  .vault-stat.warning {
    background: linear-gradient(180deg, rgb(255 247 237 / 0.96), rgb(15 23 42 / 0.94));
  }

  .vault-stat.success {
    background: linear-gradient(180deg, rgb(240 253 244 / 0.96), rgb(15 23 42 / 0.94));
  }
