  ...
  <div class="flex-cb max-md:!block" id="art-table-header">
    ...
    <div class="flex-c md:justify-end max-md:mt-3 max-sm:!hidden">
      <div
        ...
        role="button"
        tabindex="0"
        :title="buttonTitleMap.search"
        :aria-label="buttonTitleMap.search"
        @click="search"
      ...
      <div
        ...
        role="button"
        tabindex="0"
        :title="buttonTitleMap.refresh"
        :aria-label="buttonTitleMap.refresh"
        @click="refresh"
      ...
      <ElDropdown v-if="shouldShow('size')" @command="handleTableSizeChange">
        <div
          ...
          role="button"
          tabindex="0"
          :title="buttonTitleMap.size"
          :aria-label="buttonTitleMap.size"
        >
      ...
      <div
        ...
        role="button"
        tabindex="0"
        :title="isFullScreen ? buttonTitleMap.exitFullscreen : buttonTitleMap.fullscreen"
        :aria-label="isFullScreen ? buttonTitleMap.exitFullscreen : buttonTitleMap.fullscreen"
      ...
      <ElPopover v-if="shouldShow('columns')" placement="bottom" trigger="click">
        <template #reference>
          <div
            ...
            role="button"
            tabindex="0"
            :title="buttonTitleMap.columns"
            :aria-label="buttonTitleMap.columns"
          >
      ...
      <ElPopover v-if="shouldShow('settings')" placement="bottom" trigger="click">
        <template #reference>
          <div
            ...
            role="button"
            tabindex="0"
            :title="buttonTitleMap.settings"
            :aria-label="buttonTitleMap.settings"
          >
