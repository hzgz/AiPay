    ...
    <div class="relative flex-b mt-2.5 max-md:block max-md:mt-1">
      <div class="w-112 mr-5 max-md:w-full max-md:mr-0">
        <div class="art-card-sm relative p-9 pb-6 overflow-hidden text-center">
          ...
          <p class="mt-5 text-sm">当前账户用于维护后台资料与安全设置</p>
          ...
          <div class="w-75 mx-auto mt-7.5 text-left">
            ...
            <div class="mt-2.5">
              ...
              <span class="ml-2 text-sm">AiPay后台运营中心</span>
            </div>
          </div>

          <div class="mt-10">
            <h3 class="text-sm font-medium">账户标签</h3>
...
<script setup lang="ts">
  ...
  const form = reactive({
    realName: '系统管理员',
    nikeName: '运营负责人',
    email: 'service@aipay.local',
    mobile: '18888888888',
    address: '广东省深圳市宝安区西乡街道101栋201',
    sex: '2',
    des: '当前账户用于维护后台资料、密码与基础安全信息。'
  })
   ...
   * 用户标签列表
   */
  const lableList: Array<string> = ['系统管理', '资料维护', '安全设置', '运营账号']
